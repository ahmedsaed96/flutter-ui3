            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: <Widget>[
                    FadeAnimation(1.4, makeItem(image: 'assets/images/5.jpg')),
                    FadeAnimation(1.5, makeItem(image: 'assets/images/3.jpg')),
                    FadeAnimation(1.6, makeItem(image: 'assets/images/.jpg')),
                  ],
                ),
              ),
            ),
